...
if do_parallel:
    # ----- evaluator
    obj_evaluator = MPIEvaluator(executor=ProcessPoolExecutor(max_workers=max_worker),profiling=do_profiling, task_name="PARALLEL_OBJ_EVAL")
    opt_evaluator = MPIEvaluator(function_mode=False, executor=ProcessPoolExecutor(max_workers=max_worker), profiling=do_profiling, task_name="PARALLEL_IPOPT_START")
    print("\n000000\n")
